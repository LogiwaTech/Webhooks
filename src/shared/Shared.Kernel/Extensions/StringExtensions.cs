...
public static class StringExtensions
{
    ...
    {
        if (string.IsNullOrEmpty(myValue) || myValue.Length <= 0)
            return string.Empty;
            
        myValue = myValue.Trim();
        return myValue.Length > 0 ? myValue : string.Empty;
    }
    ...
    {
        return !string.IsNullOrEmpty(val) && val.Length <= maxCharLength;
    }
    ...
    {
        const string urlPattern = "[^a-zA-Z0-9-.]";
    ...
    /// <summary>
    /// Returns empty string if the value of a string is null.
    /// </summary>
    ...
    /// <summary>
    /// Converts camel case to the words.
    /// </summary>
    ...
    /// <summary>
    /// Slugifies a string for a specific url REGEX pattern.
    /// </summary>
    /// <param name="url"></param>
    /// <param name="pattern"></param>
    /// <param name="replace"></param>
    /// <returns></returns>
    public static string Tolug(this string url, string pattern, string replace = "")
    {
        var friendlyUrl = Regex.Replace(url, @"\s", "-").ToLower();
    ...
    /// <summary>
    /// Converts read only memory to string.
    /// </summary>
    /// <param name="memory"></param>
    /// <returns></returns>
    public static string ToJsonString(this ReadOnlyMemory<byte> memory)
    {
